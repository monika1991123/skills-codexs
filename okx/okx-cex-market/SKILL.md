---
name: okx-cex-market
description: "Use for read-only OKX CEX market data: ticker, order book, candles, funding, open interest, instruments, screeners, and technical indicators. Do not use for other exchanges, account balances or positions (okx-cex-portfolio), orders (okx-cex-trade), or grid/DCA bots (okx-cex-bot)."
license: MIT
metadata:
  author: okx
  version: "1.3.1"
